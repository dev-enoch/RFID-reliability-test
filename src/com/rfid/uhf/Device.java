...
public class Device {
  ...
  public native int GetReaderInformation(
    byte[] comAddr,
    byte[] versionInfo,
    byte[] readerType,
    byte[] trType,
  ...
  public native int Inventory_G2(
    byte[] comAddr,
    byte QValue,
    byte Session,
    byte MaskMem,
  ...
  public native int InventoryMix_G2(
    byte[] comAddr,
    byte QValue,
    byte Session,
    byte MaskMem,
  ...
  public native int WriteData_G2(
    byte[] comAddr,
    byte[] EPC,
    byte WNum,
    byte ENum,
  ...
  public native int BlockErase_G2(
    byte[] comAddr,
    byte[] EPC,
    byte ENum,
    byte Mem,
  ...
  public native int SetInventoryScanTime(
    byte[] comAddr,
    byte ScanTime,
    int PortHandle
  );
  ...
  public native int GetSystemParameter(
    byte[] comAddr,
    byte[] Read_mode,
    byte[] Accuracy,
    byte[] RepCondition,
  ...
  public native int SetAntennaMultiplexing(
    byte[] comAddr,
    byte Ant,
    int PortHandle
  );

  public native int SetAntennaA12(
    byte[] comAddr,
    byte SetOnce,
    byte AntCfg1,
    byte AntCfg2,
  ...
  public native int SetBeepNotification(
    byte[] comAddr,
    byte BeepEn,
    int PortHandle
  );

  public native int SetReal_timeClock(
    byte[] comAddr,
    byte[] paramer,
    int PortHandle
  );
  ...
  public native int GetReaderTemperature(
    byte[] comAddr,
    byte[] PlusMinus,
    byte[] Temperature,
    int PortHandle
  ...
  public native int MeasureReturnLoss(
    byte[] comAddr,
    byte[] TestFreq,
    byte Ant,
    byte[] ReturnLoss,
